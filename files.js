/* Files App 0.3.0 - https://files.photo.gallery/ -xkx*/
!function(e) {
    function t(e) {
    ...
    function g(e, t, i) {
        ...
        var a = M(["Model", "ApertureFNumber", "FocalLength", "ExposureTime", "ISOSpeedRatings", "gps"], (function(t) {
            ...
            if (!a)
                return "";
            if ("Model" === t)
                a = P.get_svg_icon(a.toLowerCase().indexOf("phone") > -1 ? "cellphone" : "camera") + a;
            else if ("FocalLength" === t) {
                var o = a.split("/");
                2 === o.length && (a = (o[0] / o[1]).toFixed(1) + "<small>mm</small>")
            } else if ("gps" === t)
                return n[i || "a"](a, "exif-item exif-gps");
    ...
    function Z() {
        if (U.scrollbar_width) {
            ...
            t ? t !== F.body_width && e.style.setProperty("--body-width", t + "px") : F.body_width && e.style.removeProperty("--body-width"),
            F.body_width = t
        }
    }
    var R = {
        ...
        set: function(e, t, i) {
            R.store(e),
            e.dataset.tooltip = X.get(t),
            i && e.classList.add("show-tooltip")
        },
        timer: function(e, t, i, a) {
            t && R.store(e),
            t && (e.dataset.tooltip = X.get(t)),
    ...
    function D(e) {
        if (!(e.is_dir && _c.folder_preview_image && _c.load_images && _c.image_resize_enabled))
            return "";
    ...
    _c.debug = V("debug") || 0 === location.host.indexOf("localhost"),
    _c.files = {},
    z("_c", _c);
    var P = {}
      , F = {}
    ...
    function W(e, t) {
        if (t.mime1 && t.mime0 === e)
            return U.hasOwnProperty(e) || (U[e] = function() {
    ...
    !function() {
        ...
        fail),
        e.local_storage = !!n.localStorage && function() {
            try {
                var e = "_t";
                return n.localStorage.setItem(e, e),
        ...
        e.is_touch = "ontouchstart"in n || a.maxTouchPoints > 0 || a.msMaxTouchPoints > 0 || n.DocumentTouch && t instanceof DocumentTouch || n.matchMedia("(any-pointer: coarse)").matches,
        ...
        e.scrollbar_width = e.is_pointer ? function() {
            var e = n.innerWidth - i.clientWidth;
            if (e)
                return e;
            var a = t.createElement("div");
            t.body.appendChild(a),
            a.style.cssText = "width: 100px;height: 100px;overflow: scroll;position: absolute;top: -9999px";
            var o = a.offsetWidth - a.clientWidth;
            return t.body.removeChild(a),
            o
        }() : 0,
        ...
        location.search && "URLSearchParams"in n && new URLSearchParams(location.search).forEach((function(e, t) {
    ...
    function() {
        if (U.local_storage) {
            ...
            i) {
                ...
                _c.menu_enabled || P.clean_localstorage()
        }
    }(),
    function() {
    ...
    var X = function() {
        ...
        if (U.local_storage) {
            ...
            o !== _c.version && E.set("files:version", _c.version),
            o && o !== _c.version && k(n, (function(e) {
        ...
        _c.lang_custom && (k(Object.keys(_c.lang_custom), (function(t) {
            a[t] = e(_c.lang_custom[t], t),
            a[t].flag && (l[t] = a[t].flag),
            ...
            dropdown: function() {
                ...
                if (e && "false" != e && "0" != e) {
                    ...
                    p(o, (function(e, t) {
                        ...
                        c(e),
                        P.dayjs_locale(e),
                        q.uppy && P.uppy_locale(e),
                        E.set("files:lang:current", e),
                        a.dataset.text = e,
                        s.classList.remove("dropdown-lang-active"),
                        (s = t.target).classList.add("dropdown-lang-active"))
                    }
                    ))
                }
            }
        ...
        function d(e) {
            t = !!e,
            i && i.classList.toggle("dropdown-lang-loading", t)
        }
        function m(t, i) {
            a[i] || (a[i] = e(t, i)),
            s = t,
        ...
        var f = V("lang", !0)
          , v = u(f);
        "reset" === f && E.remove("files:lang:current"),
    ...
    !function() {
        ...
        function l(t, i, a) {
            ...
            k(t, (function(o) {
                !function(t, i, a) {
                    ...
                    o[n ? "src" : "href"] = t.startsWith("http") ? t : e + t,
                    i && (o.onload = i);
                    a.error && (o.onerror = a.error);
                    n ? document.body.appendChild(o) : (o.type = "text/css",
                    o.rel = "stylesheet",
                    document.head.insertBefore(o, _tag("link", document.head)[0]))
                }(o, (function() {
                    ++n === t.length && i && i()
                }
                ), a)
        ...
        q.plugins = {
            codemirror: {
                src: [[t + "/lib/codemirror.min.js", t + "/lib/codemirror.css"], [t + "/mode/meta.js", t + "/addon/mode/loadmode.js"]],
                complete: [function() {
        ...
        "scroll" === _c.topbar_sticky && getComputedStyle(N.topbar).position.match("sticky") && P.load_plugin("headroom", (function() {
            if (Headroom.cutsTheMustard) {
                ...
                q.headroom = new Headroom(N.topbar,e),
                q.headroom.init()
            }
        }
        ))
...
//                json_response: !0,
                complete: function(t, a, o) {
                    if (o && t && t.hasOwnProperty("status"))
                        return t.status && 301 != t.status ? void (n || E.set(e, _c.qrx || btoa(i))) : l(_c.qrx)
                }
            }) : l(!0) : l()
        }
/*        function o(e, i) {
            ...
            function u(e) {
                var i = s.value.trim()
                  ...
                  , l = "submit" === e.type;
                s.classList.toggle("is-valid", a),
                s.classList.toggle("is-invalid", (i || l) && !a),
                ...
                I({
                    ...
                    complete: function(e, t, i) {
                        var a = i && e.success;
                        o.innerHTML = '<div class="alert alert-' + (a ? "success" : "danger") + ' mb-0" role="alert">' + P.get_svg_icon(a ? "check" : "alert_circle_outline") + (a ? "Great success!" : "Failed to save license key") + "</div>",
                        m(0),
                        a && (G = !0,
                        setTimeout((function() {
                            n.hide()
            ...
            i && i.Buttons({
                ...
                onError: function(e) {
                    z("error", e),
                    p.innerHTML = '<div class="alert alert-danger" role="alert">' + P.get_svg_icon("alert_circle_outline") + "Payment error</div>"
                },
                onApprove: function(e, i) {
                    return m(1),
                    z("onApprove", e, i),
                    i.order.capture().then((function(e) {
                        m(0),
                        p.innerHTML = "<p><strong>" + e.payer.name.given_name + " " + e.payer.name.surname + "</strong><br>" + e.payer.email_address + "</p><p>" + P.get_svg_icon("check") + "Thanks for purchasing! Please check your email.</p>",
                        z("details", e),
                        E.set(t, !0)
                    }
                    ))
...
//                o(e, paypal)
    ...
    function() {
        ...
        P.get_svg_large = function(e, a) {
            if (e.is_dir)
                return i(a, e.is_link, e.is_readable);
            var n = o(e)
    ...
    function() {
        if (_c.breadcrumbs) {
            N.topbar_breadcrumbs = _id("topbar-breadcrumbs"),
            N.breadcrumbs_info = N.topbar_breadcrumbs.firstElementChild;
            var e = function() {
                if (!U.download || !_c.download_dir || "files" === _c.download_dir && !U.is_pointer)
                    return !1;
                ...
                return y(i, (function(t) {
                    ...
                    if ("zip" === _c.download_dir)
                        x(e, "download-dir-disabled", !0, 1e3);
            ...
            P.breadcrumbs_info = function() {
                ...
                N.breadcrumbs_info.innerHTML = i + ' <span data-lang="' + n + '" class="breadcrumbs-info-type">' + X.get(n) + "</span>" + (t.dirsize ? '<span class="breadcrumbs-info-size">' + filesize(t.dirsize) + "</span>" : ""),
                A(N.breadcrumbs_info),
                e && ("zip" === _c.download_dir && (e.setAttribute("href", t.files_count && G ? _c.script + "?download_dir_zip=" + encodeURIComponent(t.path) + "&" + t.mtime : "#"),
                e.download = t.files_count && G ? t.basename + ".zip" : ""),
                A(e, !t.files_count)),
                q.uppy && A(a, !t.is_writeable)
            }
            ,
            N.breadcrumbs = _id("breadcrumbs");
            var n = []
              , o = [];
            N.breadcrumbs.innerHTML = l("", P.get_svg_icon("home")),
            P.set_breadcrumbs = function(t) {
                if (q.uppy && A(a, !0),
                e && A(e, !0),
                A(N.breadcrumbs_info, !0),
                ...
                o.length) {
                    ...
                    i.length ? r(i, !0) : (N.breadcrumbs.lastChild.classList.remove("crumb-active"),
                    p())
                } else
                    p()
            }
        ...
        function p() {
            ...
            n.length && k(n, (function(n, s) {
                e += e ? "/" + n : n,
                (t.length || n !== o[s]) && (a += l(e, i(n)),
                t.push(s + 1))
            }
            )),
            t.length && (N.breadcrumbs.insertAdjacentHTML("beforeend", a),
            r(function(e, t) {
                for (var i = [], a = e.length, n = 0; n < a; n++) {
                    var o = t(e[n], n);
                    o && i.push(o)
            ...
            o = n.slice(0),
            N.breadcrumbs.lastChild != N.breadcrumbs.firstChild && N.breadcrumbs.lastChild.classList.add("crumb-active")
        }
    }(),
    ...
    function() {
        ...
        function c(t) {
            if (t != e.is_open) {
                ...
                document.documentElement[i]("click", r),
                document[i]("contextmenu", r),
                document[i]("visibilitychange", r),
                window[i]("blur", r),
                window[i]("scroll", r),
                q.popup && q.popup.topbar && q.popup.topbar[i]("click", r),
                N.sidebar_menu && N.sidebar_menu[i]("scroll", r)
            }
            e.el.classList.toggle("cm-active", t),
            e.a && e.a.classList.toggle("cm-active", t),
            t != e.is_open && (anime.remove(a),
            anime({
                targets: a,
                opacity: t ? [0, 1] : 0,
                easing: "easeOutQuart",
        ...
        P.create_contextmenu = function(r, p, d, m, u) {
            if (_c.context_menu && d && m) {
                if (e.is_open) {
                    ...
                    e.el && e.el.classList.remove("cm-active"),
                    e.a && e.a.classList.remove("cm-active")
                }
                r.stopPropagation(),
                d === e.el && m === e.item || (a.innerHTML = '<h6 class="dropdown-header" title="' + t(m.basename) + '">' + i(m.basename) + "</h6>" + s("zoom", null, "popup", "popup" !== p && m.browser_image && m.is_readable) + s("open", null, "folder", "sidebar" !== p && m.is_dir) + s("show info", null, "modal", !["modal", "popup"].includes(p)) + function(e, t) {
                    var i = !!e && l(e);
                ...
                a.style.setProperty("--offset", Math.round(Math.max(10, Math.min(a.clientWidth - 10, a.clientWidth / 2 - b + x))) + "px"),
                a.classList.toggle("cm-top", _),
                a.classList.toggle("cm-bottom", h),
                a.classList.toggle("cm-border", "sidebar" === p),
                e.el = d,
                e.item = m,
                e.a = u || !1,
                c(!0),
        ...
        p(a, (function(t, i) {
            var a, n;
            ae[t] ? ae[t](e.item) : "upload" === t ? (Z(),
            q.uppy.setMeta({
                path: e.item.path
            }),
            q.uppy.getPlugin("Dashboard").openModal()) : "popup" === t ? (_c.history && q.modal.open && q.modal.popstate.remove(),
            P.open_popup(e.item)) : "folder" === t ? (q.modal.open && P.close_modal(),
            P.get_files(e.item.path, "push")) : "modal" === t ? P.open_modal(e.item, !0) : "clipboard" === t && (a = l(e.item),
            (n = new URL(a,location)) && h(n.href))
        }
        ))
    }(),
    q.dropdown = {},
    function() {
        var e, t = U.pointer_events ? "pointerdown" : U.only_touch ? "touchstart" : "mousedown", i = U.pointer_events ? "pointerup" : "click";
        function a(i) {
            i.classList.contains("touch-open") ? e && e.remove() : e = L(document, t, (function(t) {
                t.target.closest(".dropdown") !== i && (e.remove(),
                i.classList.remove("touch-open"),
                N.files.style.pointerEvents = "none",
                setTimeout((function() {
        ...
        U.is_touch && document.addEventListener("touchstart", (function() {}
        ), !0),
        P.dropdown = function(e, t, n) {
            ...
            U.is_dual_input ? U.pointer_events && y(t, (function(t) {
    ...
    var Q = Swal.mixin({
        ...
        inputValidator: e=>{
            var t = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
            if (t)
                return "Invalid characters " + t.join(" ")
        }
        ,
        scrollbarPadding: !1,
        ...
        function e(e, t, i, o) {
            ...
            I({
                ...
                always: function() {
                    ...
                    N.files.parentElement.classList.remove("fm-processing")
                },
                complete: function(i, a, n) {
                    return z("fm:task:" + e, i, t),
                    n && i && a ? i.error ? ee.fire({
                        title: i.error
                    }) : i.success ? (q.contextmenu.item === t && delete q.contextmenu.el,
                    void (o && o(l, s, r, c, i))) : ee.fire() : ee.fire()
                }
            })
        }
        function a(e) {
            ...
            duplicate: function(t) {
                ...
                Q.fire({
                    ...
                    i.isConfirmed && i.value && i.value !== t.basename && e("duplicate", t, "&name=" + encodeURI(i.value), (function(e, t, i, a) {
                        ...
                        delete a.html,
                        delete a.json_cache,
                        E.remove(le(a.path, a.mtime)),
                        a === _c.current_dir && P.get_files(_c.current_path, "replace", !0))
                    }
                    ))
                }
                ))
            ...
            rename: function(t) {
                Q.fire({
                    ...
                    inputValidator: e=>{
                        ...
                        var i = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
                        if (i)
                            return "Invalid characters " + i.join(" ");
                        ...
                        e("rename", t, "&name=" + encodeURI(a), (function(e, i, l, s) {
                            ...
                            if (s) {
                                if (s === _c.current_dir && s.files) {
                                    ...
                                    if (i && i.isConnected) {
                                        i.setAttribute("href", o(m, "download" === _c.click)),
                                        i.dataset.name = a,
                                        ...
                                        if (!t.is_dir && "IMG" === u.nodeName) {
                                            ...
                                            u.dataset.src = f,
                                            u.hasAttribute("src") && u.setAttribute("src", f)
                                        }
                                        e._values = m,
                                        P.set_sort()
                                    }
                                    delete m.popup_caption,
                                    delete s.files[r]
                                } else
                                    delete s.files;
                                if (s.preview === r) {
                            ...
                            t.is_dir && (_c.dir_paths.filter((e=>e.startsWith(c))).forEach((function(e) {
                                ...
                                if (e === c && (l.basename = a),
                                delete _c.dirs[e],
                                E.remove(le(e, l.mtime)),
                                N.sidebar_menu) {
                                    var s = _query('[data-path="' + n(e) + '"]', N.sidebar_menu);
                                    s && (e === c && (s.firstElementChild.lastChild.textContent = a),
                                    s.dataset.path = i,
                                    s.firstElementChild.setAttribute("href", o(l)))
                                }
                            }
                            )),
                            _c.dir_paths = Object.keys(_c.dirs),
                            _c.current_path.startsWith(c) && P.get_files(_c.current_dir.path, "push"))
                        }
                        ))
                    }
                }
                        ...
                        e("new_folder", a, "&name=" + encodeURI(l), (function(e, n, s, r) {
                            ...
                            if (c) {
                                ...
                                s) {
                                    ...
                                    m ? m.insertAdjacentHTML("afterbegin", f) : (s.firstElementChild.firstElementChild.remove(),
                                    s.firstElementChild.insertAdjacentHTML("afterbegin", P.get_svg_icon_multi_class("menu-icon menu-icon-toggle", "plus", "minus") + P.get_svg_icon_multi_class("menu-icon menu-icon-folder menu-icon-folder-toggle", "folder", "folder_plus", "folder_minus")),
                                    s.classList.add("has-ul"),
                                    s.insertAdjacentHTML("beforeend", '<ul style="--depth:' + u + '" class="menu-ul">' + f + "</ul>")),
                ...
                Q.fire({
                    ...
                    if (i.isConfirmed && i.value) {
                        ...
                        e("new_file", t, "&name=" + encodeURI(a), (function(e, i, n, o) {
                            ...
                            delete l.html,
                            delete l.json_cache,
                            E.remove(le(l.path, l.mtime)),
                            l === _c.current_dir && P.get_files(_c.current_path, "replace", !0))
                        }
                        ))
                    }
                }
            ...
            delete: function(t) {
                ie.fire(X.get("delete", !0), t.basename).then((i=>{
                    i.isConfirmed && e("delete", t, null, (function(e, i, a, n, o) {
                        ...
                        n.files && delete n.files[t.basename],
                        delete n.html,
                        delete n.json_cache,
                        E.remove(le(n.path, n.mtime)),
                        "image" === t.mime0 && n.images_count && n.images_count--,
                        !t.is_dir && n.files_count && n.files_count--,
                        n.dirsize && t.filesize && (n.dirsize -= t.filesize),
                        n.preview === t.basename) {
                            delete n.preview;
                            var l = n.path.split("/").slice(0, -1).join("/");
                            l && _c.dirs[l] && delete _c.dirs[l].html
                        }
                        if (n === _c.current_dir && (_c.file_names = Object.keys(_c.files),
                        _c.files_count = _c.file_names.length,
                        _c.breadcrumbs && P.breadcrumbs_info(),
                        q.list.remove("path", t.path)),
                        t.is_dir) {
                            if (_c.dir_paths = _c.dir_paths.filter((function(e) {
                                if (!e.startsWith(t.path))
                                    return !0;
                                var i = _c.dirs[e];
                                i && (E.remove(le(i.path, i.mtime)),
                                delete _c.dirs[e])
                            }
                            )),
                            a && a.isConnected) {
                                var s = a.parentElement;
                                if (s.children.length > 1 || "LI" !== s.parentElement.tagName)
                                    a.remove();
                                else {
                                    var r = s.parentElement;
                                    s.remove(),
                                    r.classList.remove("has-ul", "menu-li-open");
                                    var c = r.firstElementChild;
                                    c.firstElementChild.remove();
                                    var p = c.firstElementChild;
                                    p.lastElementChild.remove(),
                                    p.lastElementChild.remove(),
                                    p.classList.remove("menu-icon-folder-toggle")
                                }
                            }
    ...
    _c.allow_upload && P.load_plugin("uppy", (function() {
        ...
        var e = q.uppy = new Uppy.Core({
            ...
            delete a.html,
            delete a.json_cache,
            E.remove(le(i, a.mtime)))
        }
        )).on("dashboard:modal-open", (()=>{
            var i, a;
            G || t.classList.add("uppy-nolicense"),
            i = _c.upload_max_filesize ? filesize(_c.upload_max_filesize) : "",
            a = e.getState().meta.path || _c.current_path || "/",
            e.getPlugin("Dashboard").setOptions({
            ...
            if (100 === t.totalProgress) {
                ...
                P.get_files(t.meta.path, i ? "replace" : "push", i),
                e.reset()
            }
        }
        ...
        function i(t, i) {
            ...
            !!t !== a.isModalOpen() && (a[t ? "openModal" : "closeModal"](),
            i && e.setMeta({
                path: i
            }))
        }
        ...
        _c.demo_mode && t.classList.add("uppy-demo-mode"),
        _c.allow_delete && t.classList.add("uppy-allow-delete"),
        P.uppy_locale = function(e) {
    ...
    var oe = function() {
        var e, t = "", i = screen.width >= 768, a = _c.filter_live && U.is_pointer, n = function() {
        ...
        var l = {
            create: function() {
                q.list = new List(N.files.parentElement,{}),
            ...
            filter: function(e) {
                if (t !== N.filter.value && q.list) {
                    ...
                    N.filter.className !== a && (N.filter.className = a),
                    P.topbar_info_search(t, i),
    ...
    !function() {
            ...
            if (_c.transitions && _c.files_count)
                if ("list" !== _c.layout) {
                    ...
                    var d = {
                        ...
                        duration: t ? 300 : 150,
                        complete: function() {
                            t || N.files.style.removeProperty("opacity"),
                            i && i()
                        }
                    };
                    anime(d)
        ...
        function c(e, t, i) {
            document.title = t || "/",
            i && _c.history && history[i + "State"]({
                path: e
            }, t, function(e, t) {
                if ("replace" === e) {
                    if (_c.query_path || !t)
                        return _c.query_path = !1,
                        location.href
                } else if (!t)
        ...
        function d() {
            return _c.current_dir.html = M(_c.file_names, (function(e, r) {
                var c = _c.files[e];
                if (!c.is_dir && (!c.mime && c.ext && (c.mime = se[c.ext]),
                c.mime)) {
                    var p = c.mime.split("/");
                    c.mime0 = p[0],
                    p[1] && (c.mime1 = p[1])
                }
                c.image && (c.image.exif && c.image.exif.gps && Array.isArray(c.image.exif.gps) && (c.gps = c.image.exif.gps),
                c.image.width && c.image.height && (c.dimensions = [c.image.width, c.image.height],
                c.ratio = c.image.width / c.image.height),
                c.image.iptc && Object.assign(c, c.image.iptc));
                var d = function() {
                    if (c.mime1) {
                        if ("image" === c.mime0) {
                            if (!U.browser_images.includes(c.mime1))
                                return;
                            if (c.browser_image = c.mime0,
                            c.is_popup = !0,
                            !_c.load_images || !c.is_readable)
                                return;
                            var e = !1
                              , t = "files-img files-img-placeholder files-lazy";
                            if ("svg+xml" === c.browser_image || "svg" === c.ext) {
                                if (c.filesize > _c.load_svg_max_filesize)
                                    return;
                                t += " files-img-svg"
                            } else {
                                if (function(e) {
                                ...
                                !e && c.filesize > _c.load_images_max_filesize)
                                    return;
                                "ico" === c.ext && (t += " files-img-ico"),
                                c.dimensions && (c.preview_dimensions = e ? c.ratio > 1 ? [e, Math.round(e / c.ratio)] : [Math.round(e * c.ratio), e] : [c.image.width, c.image.height],
                                c.preview_ratio = c.preview_dimensions[0] / c.preview_dimensions[1])
                            }
                            return '<img class="' + t + '" data-src="' + function() {
                                if (s)
                                    return s + encodeURI(c.path);
                                if (e && c.image["resize" + e])
                                    return encodeURI(c.image["resize" + e]);
                                if (!e && !_c.load_files_proxy_php && c.url_path)
                        ...
                        return "video" === c.mime0 && (W("video", c) && (c.is_browser_video = !0,
                        _c.popup_video && (c.is_popup = !0)),
                        _c.video_thumbs_enabled && c.is_readable) ? (c.preview_dimensions = [480, 320],
                        c.preview_ratio = 1.5,
                        (c.is_browser_video ? P.get_svg_icon("play") : "") + '<img class="files-img files-img-placeholder files-lazy" data-src="' + _c.script + "?file=" + encodeURIComponent(c.path) + "&resize=video&" + _c.image_cache_hash + "." + c.mtime + "." + c.filesize + '"' + (c.preview_dimensions ? ' width="' + c.preview_dimensions[0] + '" height="' + c.preview_dimensions[1] + '"' : "") + ">") : void 0
                    }
                }();
                return function(e) {
                    ...
                    if (i) {
                        ...
                        o && (t += ",exif",
                        o.gps && (t += ",gps,maps"),
                        t += M(["Make", "Model", "Software"], (function(e) {
                            if (o[e])
                                return "," + o[e]
                        }
                        ))),
        ...
        function v(e, t, i) {
            ...
            c(e, _c.current_dir.basename, t),
            _c.files = _c.current_dir.files,
            z(i + " :", e, _c.current_dir),
            _c.file_names = Object.keys(_c.files),
            _c.files_count = _c.file_names.length,
            _c.files_count && !_c.current_dir.html && (_c.current_dir.resort = !1,
            _c.file_names.sort((function(e, t) {
            ...
            _c.breadcrumbs && P.breadcrumbs_info(),
            _c.files_count || P.topbar_info(P.get_svg_icon("alert_circle_outline") + '<span data-lang="directory is empty" class="f-inline-block">' + X.get("directory is empty") + "</span>", "warning"),
            oe.disabled(!_c.files_count),
            A(N.sortbar, !_c.files_count),
            _c.files_count && (N.files.innerHTML = _c.current_dir.html || d(),
            oe.create(),
            "push" !== t && oe.hash(!0),
            "name" == q.sort.sort && "asc" == q.sort.order || P.set_sort(),
        ...
        function h(e, t, i) {
            A(N.sortbar, !0),
            P.topbar_info(P.get_svg_icon("alert_circle_outline") + '<strong data-lang="error" class="f-inline-block">' + X.get("error") + "</strong>" + (e ? ": " + e : "."), "error"),
            c(t, X.get("error") + (e ? ": " + e : "."), i)
        }
        image_load_errors = 0,
        ...
        P.get_files = function(t, i, a) {
            if (a || t !== _c.current_path) {
                _c.current_path = t,
                N.topbar_info.className = "info-hidden",
                oe.clear(),
                !a && _c.breadcrumbs && P.set_breadcrumbs(t),
                !a && _c.menu_enabled && P.set_menu_active(t);
                var n = _c.dirs[t];
                if (!a && n) {
                    if (n.files)
                        return r(!1, (function() {
                    ...
                    if (o)
                        ...
                        r(!1, (function() {
                            oe.empty(),
                            v(t, i, "files from localStorage")
                        }
                        ))
                }
                oe.disabled(!0),
                _c.menu_enabled && P.menu_loading(!1, !0),
                N.topbar.classList.add("topbar-spinner");
                var l = 0
                ...
                e = I({
                    ...
                    always: ()=>{
                        e = !1,
                        _c.menu_enabled && P.menu_loading(!1, !1),
                        N.topbar.classList.remove("topbar-spinner")
                    }
                    ,
                    complete: function(e, a, n) {
                        return n ? e.error ? h(e.error + " " + t, t, i) : (_(t, e),
                        E.set(le(t, e.mtime), a, !1, 1e3),
                        void c()) : h(t, t, i)
                    }
                })
            }
        ...
        P.init_files = function() {
            if (_c.query_path)
                return _c.query_path_valid ? P.get_files(_c.query_path, "replace") : h("Invalid directory " + _c.query_path, _c.query_path, "replace");
            if (location.search) {
                ...
                if (e && "debug" !== e && (-1 === e.indexOf("=") || e.indexOf("/") > -1)) {
                    ...
                    return void (t || !_c.menu_enabled ? (t && _(_c.query_path, t),
                    P.get_files(_c.query_path, "replace")) : P.menu_init_files(_c.query_path))
                }
            }
        ...
        P.menu_init_files = function(e) {
            if (e) {
                if (_c.dir_paths)
                    return P.get_files(e, "replace");
                x = e
            } else
                x && P.get_files(x, "replace")
        }
        ,
            ...
            if (t !== N.files) {
                ...
                if (a) {
                    if (t.classList.contains("context-button"))
                        return P.create_contextmenu(e, "files", t, a, i);
                    if (q.contextmenu.is_open && ("menu" !== _c.click || a.is_dir))
                        return e.preventDefault();
                    if (t.dataset.href)
                        return e.preventDefault(),
                        window.open(t.dataset.href);
                    if (a.is_dir || !("window" === _c.click || a.ext && click_window.includes(a.ext)))
                        (a.is_dir || "download" !== _c.click) && (b(e, i) || (e.preventDefault(),
                        a.is_dir ? (_(a.path, a),
                        P.get_files(a.path, "push")) : "menu" === _c.click ? P.create_contextmenu(e, "files", i, a) : "popup" === _c.click && a.is_popup && a.is_readable ? P.open_popup(a) : P.open_modal(a, !0)));
    ...
    function() {
        ...
        N.files.className != "list files-" + _c.layout && (N.files.className = "list files-" + _c.layout);
        var i = getComputedStyle(N.files).getPropertyValue("--img-object-fit").trim() || "cover"
          , a = E.get("files:interface:img-object-fit") || i;
        function n() {
            N.files.style.setProperty("--imagelist-height", o ? "100px" : "100%"),
            N.files.style[(o ? "set" : "remove") + "Property"]("--imagelist-min-height", "auto")
        }
        ...
        null === o && (o = "auto" !== getComputedStyle(N.files).getPropertyValue("--imagelist-height").trim()),
        n(),
        ["grid", "rows", "columns"].forEach((function(t) {
            var i, a = e[t].size, n = getComputedStyle(N.files).getPropertyValue("--" + t + "-size");
            n && (a.default = parseInt(n)),
            a.current = !(i = E.get("files:layout:" + t + "-size")) || isNaN(i) || i == a.default ? a.default : (i = O(a.min, a.max, i),
            N.files.style.setProperty("--" + t + "-size", i + "px"),
            i),
            a.space = function() {
                var e = E.get("files:layout:" + t + "-space-factor");
                return !e || isNaN(e) || 50 == e ? 50 : (e = O(0, 100, e),
                N.files.style.setProperty("--" + t + "-space-factor", e),
                0 == e && N.files.style.setProperty("--" + t + "-border-radius", 0),
                e)
            }()
        }
        ));
        ...
        function r() {
            var e = s.ob;
            v.style.display = "imagelist" === s.layout || e.size || e.contain ? "" : "none",
            g.style.display = e.size ? "" : "none",
            b.style.display = e.size ? "" : "none",
            C.style.display = e.contain ? "" : "none",
            k.style.display = "imagelist" === s.layout ? "" : "none",
            e.size && (e.size.min && (h.min = e.size.min),
            e.size.max && (h.max = e.size.max),
            e.size.default && (x.value = e.size.default,
            h.style.setProperty("--range-default-pos", (e.size.default - e.size.min) / (e.size.max - e.size.min))),
            X.set(_, s.layout),
            h.value = e.size.current,
            X.set(w, s.layout),
            L.value = e.size.space)
        }
        ...
        function A(e) {
            s.layout !== e && (d.innerHTML = P.get_svg_icon("layout_" + e),
            f[s.index].classList.remove("active"),
            s = l(e),
            f[s.index].classList.add("active"),
            r(),
            N.files.className = "list files-" + e,
            N.sortbar.className = "sortbar-" + e,
            P.set_config("layout", e))
        }
        y(h, (function(e) {
        ...
        y(h, (function(e) {
            ...
            E.set("files:layout:" + s.layout + "-size", h.value)
        }
        ), "change"),
        y(L, (function(e) {
        ...
        y(L, (function(e) {
            ...
            _c.files_count > z && N.files.style.setProperty("--" + s.layout + "-space-factor", t),
            N.files.style[(t > 0 ? "remove" : "set") + "Property"]("--" + s.layout + "-border-radius", 0),
            E.set("files:layout:" + s.layout + "-space-factor", t)
        }
        ), "change"),
        y(H, (function() {
            (a = this.checked ? "cover" : "contain") == i ? (N.files.style.removeProperty("--img-object-fit"),
            E.remove("files:interface:img-object-fit")) : (N.files.style.setProperty("--img-object-fit", a),
            E.set("files:interface:img-object-fit", a))
        }
        ), "change"),
        y(V, (function() {
            o = this.checked,
            n(),
            E.set("files:layout:imagelist-square", o)
        }
        ), "change"),
        p(u, A),
        P.dropdown(c, d, (function() {
    ...
    function() {
        ...
        var n, l, s, c = E.get("files:popup:locked_caption"), p = screen.width < 375 ? "ll" : screen.width < 414 ? "lll" : "llll", d = screen.width >= 576, h = {
            ...
            getThumbBoundsFn: function(e, t) {
                ...
                if (!(i.w && i.h && i.msrc && a && a.offsetParent))
                    return !!t && x(!0);
            ...
            addCaptionHTMLFn: function(t, n) {
                var o = t.item;
                if ("topbar" === a)
                    return e.search.innerHTML = o.basename,
                    !1;
                if (!N.filter.value) {
                    if ("video" === t.type)
                        return e.search.innerHTML = o.basename,
                ...
                return o.hasOwnProperty("popup_caption") || (o.popup_caption = f(U.PointerEvent, "popup-context") + '<div class="popup-basename">' + i(o.basename) + "</div>" + m(o.dimensions, "popup-dimensions") + u(o, "popup-filesize") + '<span class="popup-date">' + P.get_time(o, p, "LLLL", d) + "</span>" + g(o.image, "popup-exif") + v(o.image, "popup")),
                ...
                !0) : ce.resetEl(e.caption_center)
            }
        };
        function x(t) {
            t !== n.options.showHideOpacity && (n.options.showHideOpacity = t,
            ce.toggle_class(e.pswp, "pswp--animate_opacity", t))
        }
        function b(t) {
        ...
        P.open_popup = function(t, l) {
            if (t && q.list.items.length && !e.is_open) {
                    ...
                    s.forEach((function(i, a) {
                        ...
                        if (n && n.is_readable && n.is_popup) {
                            if (n.browser_image) {
                                ...
                                if (s && (p.w = n.image.height,
                                p.h = n.image.width),
                                r && !p.msrc && (l.onload = function() {
                ...
                "topbar" !== a && N.filter.value && (e.search.innerHTML = P.get_svg_icon("image_search_outline") + '"' + i(N.filter.value) + '"'),
                e.slides.length < 3 && (c.playEl = !1),
                n = new pe(e.pswp,re,e.slides,Object.assign({}, h, c, {
                ...
                n.listen("beforeChange", (function() {
                    w("video" == n.currItem.type && n.currItem.container),
                    e.toggle_timer(!1)
                }
                )),
                n.listen("afterChange", (function() {
                    e.ui.classList.toggle("popup-ui-video", "video" == n.currItem.type),
                    e.toggle_timer(!0)
                }
                )),
                ...
                n.listen("destroy", (function() {
                    ...
                    e.preloader.classList.remove("svg-preloader-active");
        ...
        e.toggle_play = function(t) {
            t === e.playing || t && L() || (e.playing = !!t,
            ce.toggle_class(e.play_button, "is-playing", t),
            e.toggle_timer(t))
        }
        ,
        e.toggle_timer = function(t) {
            ...
            if ((!t || e.playing && (n.currItem.loaded || !n.currItem.src)) && e.timer != t) {
                e.timer = !!t,
                t && (e.play_timer.style.opacity = 1),
        ...
        e.caption.addEventListener("click", (function(t) {
            return t.target.classList.contains("pswp__button--lock-caption") ? (c = !c,
            ce.toggle_class(e.caption, "pswp__caption-locked", c),
            E.set("files:popup:locked_caption", c, !0)) : "context" == t.target.dataset.action ? P.create_contextmenu(t, "popup", t.target, n.currItem.item) : void (U.is_pointer && 0 === t.target.className.indexOf("pswp") && ("right" === caption_align && t.pageX > this.clientWidth - 49 ? n.next() : "left" === caption_align && t.pageX < 49 && n.prev()))
        }
        )),
...
/**        _c.check_updates && (E.get("files:updated") ? (E.remove("files:updated"),
        ...
        e.classList.add("updated")) : I({
            json_response: !0,
            params: "action=check_updates",
            complete: function(i, a, n) {
                if (i && a && n && i.hasOwnProperty("success")) {
                    var o = i.success;
                    if (z(o ? "New version " + o + " available." : "Already using latest version " + _c.version),
                    o) {
                    ...
                    z("Failed to load external JSON check_updates.")
            }
        }))
*/
    }(),
    ...
    !function() {
        ...
        !!_c.allow_text_edit && s.children[0])
          , x = a.children[1];
        q.modal = {};
        var y = w((function() {
        ...
        function C(e) {
            N.modal.style.display = e ? "block" : "none",
            N.modal_bg.style.display = e ? "block" : "none",
        ...
        P.open_modal = function(n, r) {
            ...
            !n.is_dir && n.is_readable)
                if (n.browser_image)
                    q.modal.type = "image",
                    n.dimensions && n.dimensions[0] > 800 && n.ratio > 1 && document.documentElement.clientWidth >= 1600 && (d = !0),
                    p = '<img data-action="zoom" src="' + o(n) + '" class="modal-image files-img-placeholder' + ("ico" == n.ext ? " modal-image-ico" : "") + '"' + (!n.dimensions || !_c.server_exif && U.image_orientation || !U.image_orientation && T(n.image) ? "" : ' width="' + n.dimensions[0] + '" height="' + n.dimensions[1] + '" style="--ratio:' + n.ratio + '"') + "></img>";
                else if (n.is_browser_video)
                    q.modal.type = "video",
                    p = '<video src="' + o(n) + '" type="' + n.mime + '" class="modal-video" controls playsinline disablepictureinpicture controlslist="nodownload"' + (_c.video_autoplay ? " autoplay" : "") + "></video>";
                else if (_c.video_thumbs_enabled && "video" === n.mime0 && n.is_readable)
                    q.modal.type = "video-thumb",
                    p = '<img src="' + _c.script + "?file=" + encodeURIComponent(n.path) + "&resize=video&" + _c.image_cache_hash + "." + n.mtime + "." + n.filesize + '" class="modal-image files-img-placeholder" width="' + n.preview_dimensions[0] + '" height="' + n.preview_dimensions[1] + '" style="--ratio:' + n.preview_ratio + '"></img>';
                else if (W("audio", n))
                    q.modal.type = "audio",
                    p = P.get_svg_large(n, "modal-svg") + '<audio src="' + o(n) + '" type="' + n.mime + '" class="modal-audio" controls playsinline controlslist="nodownload"></audio>';
                else {
                    ...
                    n.code_mode && (q.modal.type = "code",
                    n.filesize > 1e3 && (d = !0),
                    P.load_plugin("codemirror"),
                    p = '<div class="spinner-border modal-preview-spinner"></div>' + P.get_svg_large(n, "modal-svg"))
                }
            ...
            t.classList.toggle("modal-lg", d),
            a.classList.add("modal-content-" + q.modal.type),
            l.innerText = n.basename,
            U.is_pointer && (l.title = n.basename),
            x.innerHTML = b;
            ...
            _c.history && (r && history.pushState(null, n.basename, "#" + encodeURIComponent(n.basename)),
            q.modal.popstate = L(window, "popstate", (function() {
                P.close_modal()
            }
            ))),
            w = function() {
                if (n.code_mode) {
                    ...
                    e.file = I({
                        ...
                        complete: function(i) {
                            e.file = !1,
                            P.load_plugin("codemirror", (function() {
                                if (q.modal.open === t) {
                                    c(_class("modal-preview-spinner", x));
                                    var e = _class("modal-preview-code", x)[0];
                                    e && (c(_class("modal-svg", x)),
                                    q.modal.code_mirror = CodeMirror(e, {
                                        value: i,
                                        lineWrapping: !0,
                                        lineNumbers: !0,
                                    ...
                                    CodeMirror.autoLoadMode(q.modal.code_mirror, n.code_mode),
                                    q.modal.resize_listener = L(window, "resize", y),
                                    s.style.display = "")
                                }
                            }
                            ))
            ...
            ,
            q.modal.open = Math.random(),
            j("esc", P.close_modal, "keyup"),
            Z(),
            C(!0),
            H(N.modal_bg, [0, .8]),
            H(a, [0, 1], [.98, 1], w)
        ...
        P.close_modal = function(t) {
            ...
            e.file && e.file.abort(),
            j("esc", "keyup"),
            q.modal.resize_listener && q.modal.resize_listener.remove(),
            H(N.modal_bg, [.8, 0]),
            H(a, [1, 0], [1, .98], (function() {
                N.modal.scrollTop = 0,
                C(),
                r(x),
                r(l),
                N.modal.classList.remove("modal-code-fullscreen"),
                a.classList.remove("modal-content-" + q.modal.type),
                q.modal.code_mirror = !1,
                "code" === q.modal.type && (s.style.display = "none")
            }
            )),
            _c.history && q.modal.popstate) {
                if (q.modal.popstate.remove(),
                !t)
                    return;
        ...
        function M(e, t) {
            k = !1,
            d.classList.remove("tooltip-loading"),
            R.timer(d, t, e ? "success" : "danger")
        }
        function V(e) {
            if (!k && !d.disabled) {
                if (_c.demo_mode)
                    return ee.fire("Demo mode");
                if (!G)
                    return te.fire();
                if (!q.modal.item.is_writeable)
                    return ee.fire("File is not writeable");
                k = !0,
                d.classList.add("tooltip-loading");
                var t = _c.current_dir;
                I({
                    ...
                    complete: function(e) {
                        M(e.success, e.error),
                        e.success ? ($.fire(X.get("save", !0) + " " + q.modal.item.basename),
                        E.remove(le(t.path, t.path.mtime)),
                        delete t.files,
                        delete t.html) : ee.fire(e.error)
                    }
                })
            }
        }
        function z() {
            N.modal.classList.toggle("modal-code-fullscreen"),
            y()
        }
        p(N.modal, (function(e, t) {
            if ("context" === e)
                P.create_contextmenu(t, "modal", t.target, q.modal.item);
            else if ("close" === e)
                P.close_modal(!0);
            else if ("zoom" === e) {
                if (q.contextmenu.is_open)
                    return t.preventDefault();
                if (b(t, t.target.closest(".modal-preview")))
                    return;
                q.modal.popstate.remove(),
                P.open_popup(q.modal.item)
            } else if ("copy" === e) {
                var i = q.modal.code_mirror.getValue()
                  , a = i && h(i);
                R.timer(t.target, !1, a ? "success" : "danger")
            } else
                "fullscreen" === e ? z() : "save" === e && V()
        }
        ))
    }();
    var re = function(e, t) {
        var i, a, n, o, l, s, r, c, p, m, u, f, v, g, _, h, x, b = this, y = !1, w = !0, L = {
            timeToIdle: 3e3,
            ...
            if (_)
                return !0;
            e = e || window.event,
            g.timeToIdle && g.mouseUsed && !c && z();
            for (var t, i, a = e.target || e.srcElement, n = 0; n < E.length; n++)
                (t = E[n]).onTap && a.classList.contains("pswp__" + t.name) && (t.onTap(),
                i = !0);
            i && (e.stopPropagation(),
            _ = !0,
            setTimeout((function() {
            ...
            32 === e.keyCode && (U.is_dual_input && b.toggleControls(!1),
            b.setIdle(!c))
        }, k = function(e, t, i) {
            e.classList[i ? "add" : "remove"]("pswp__" + t)
        }, M = function() {
            var e = 1 === g.getNumItemsFn();
            e !== v && (k(i, "ui--one-slide", e),
            v = e)
        }, V = 0, z = function() {
            clearTimeout(x),
            V = 0,
            ...
            u !== e && (t.toggle_class(m, "svg-preloader-active", !e),
            u = e)
        }, E = [{
            name: "caption",
            option: "captionEl",
        ...
        b.init = function() {
            ...
            p("onPinchClose", (function(e) {
                w && e < .9 ? (b.toggleControls(),
                n = !0) : n && !w && e > .9 && b.toggleControls(!0)
            }
            )),
            ...
            g.downloadEl && p("afterChange", (function() {
            ...
            p("bindEvents", (function() {
                ...
                t.bind(q.popup.scrollwrap, "pswpTap", b.onGlobalTap),
                t.bind(document, "keydown", H)
            }
            )),
            p("unbindEvents", (function() {
                ...
                t.unbind(q.popup.scrollwrap, "pswpTap", b.onGlobalTap),
                t.unbind(document, "keydown", H)
            }
            )),
            p("destroy", (function() {
                g.captionEl && a.classList.remove("pswp__caption--empty"),
                ...
                if (e)
                    for (var t = e.length, i = 0; i < t; i++) {
                        ...
                        for (var a = 0; a < E.length; a++)
                            l = E[a],
                            o.classList.contains("pswp__" + l.name) && (g[l.option] ? (o.classList.remove("pswp__element--disabled"),
                            l.onInit && l.onInit(o)) : o.classList.add("pswp__element--disabled"))
                    }
            }
            )(i.children),
            c(q.popup.topbar.children),
            M(),
        ...
        b.updateIndexIndicator = function() {
            g.counterEl && (n.innerHTML = e.getCurrentIndex() + 1 + g.indexIndicatorSep + g.getNumItemsFn()),
            !g.loop && g.arrowEl && g.getNumItemsFn() > 1 && (t.toggle_class(o, "pswp__element--disabled", 0 === e.getCurrentIndex()),
            t.toggle_class(l, "pswp__element--disabled", e.getCurrentIndex() === g.getNumItemsFn() - 1))
        }
        ,
            ...
            if (!_)
                if (t.detail && "mouse" === t.detail.pointerType) {
                    if (!t.detail.rightClick)
                        if (("zoom" == g.click || g.getNumItemsFn() < 2 || e.getZoomLevel() > e.currItem.fitRatio) && i.classList.contains("pswp__img"))
                    ...
                    U.is_dual_input ? U.legacy_ie || b.setIdle(!c) : b.toggleControls(!w)
        }
        ,
      ...
      , pe = function(e, t, i, a) {
        ...
        var l, s, r, c, p, d, m, u, f, v, g, _, h, x, b, y, w, L, C, H, k, M, V, z, A, j, E, I, T, S, O, Z, R, D, P, F, N, W, B, X, Y, G, K, Q, J, $, ee, te, ie, ae, ne, oe = {
            ...
            ie = e,
            q.popup.bg.style.opacity = e * o.bgOpacity
        }, Le = function(e, t, i, a, o) {
            (!ve || o && o !== n.currItem) && (a /= o ? o.fitRatio : n.currItem.fitRatio),
            e.transform = _ + t + "px, " + i + "px, 0px) scale(" + a + ")"
        }, Ce = function(e) {
            Q && !n.currItem.loadError && (e && (v > n.currItem.fitRatio ? ve || (Bt(n.currItem, !1, !0),
            ve = !0) : ve && (Bt(n.currItem),
            ve = !1)),
            Le(Q, se.x, se.y, v))
        }, He = function(e) {
            ...
            E.is_mouse || (e.classList.add("pswp--has_mouse"),
            z += " pswp--has_mouse",
            E.is_mouse = o.mouseUsed = !0),
            be("mouseUsed")
        }, Ee = null, Ie = function() {
            Ee && (ce.unbind(document, "mousemove", Ie),
            je()),
            ...
            e && (N || F || J || R) && (e.preventDefault(),
            e.stopPropagation())
        }, Pe = function() {
            n.setScrollOffset(0, ce.getScrollY())
        }, Fe = {}, qe = 0, Ne = function(e) {
            Fe[e] && (Fe[e].raf && V(Fe[e].raf),
            qe--,
            delete Fe[e])
        }, Ue = function(e) {
            Fe[e] && Ne(e),
            ...
            init: function() {
                if (!l && !s) {
                    ...
                    i = 0; i < fe.length; i++)
                        n["init" + fe[i]]();
                    if (t)
                        (n.ui = new t(n,ce)).init();
                    be("firstUpdate"),
                    c = c || o.index || 0,
                    (isNaN(c) || c < 0 || c >= Zt()) && (c = 0),
                    n.currItem = Ot(c),
                    e.setAttribute("aria-hidden", "false"),
                    void 0 === j && (be("initialLayout"),
                    j = A = ce.getScrollY());
                    ...
                    ce.bind(q.popup.scrollwrap, u, n),
                    xe("initialZoomInEnd", (function() {
                        n.setContent(x[0], c - 1),
                        n.setContent(x[2], c + 1),
                        x[0].el.style.display = x[2].el.style.display = "block",
                        o.focus && e.focus(),
                        ce.bind(document, "keydown", n),
                        ce.bind(q.popup.scrollwrap, "click", n),
                        E.is_mouse ? je() : U.is_pointer && ce.bind(document, "mousemove", Ie),
                        ce.bind(window, "resize scroll orientationchange", n),
                        be("bindEvents")
                    }
                    )),
                    n.setContent(x[1], c),
            ...
            close: function() {
                ...
                ce.unbind(window, "scroll", f.scroll),
                ce.unbind(document, "keydown", n),
                U.is_pointer && ce.unbind(document, "mousemove", Ie),
                ce.unbind(q.popup.scrollwrap, "click", n),
                D && ce.unbind(window, m, n),
                clearTimeout(I),
                be("unbindEvents"),
                Rt(n.currItem, null, !0, n.destroy))
            },
            destroy: function() {
                be("destroy"),
                Et && clearTimeout(Et),
                ...
                e.className = z,
                ce.unbind(q.popup.scrollwrap, u, n),
                ce.unbind(window, "scroll", n),
                pt(),
                We(),
                he = {}
            },
            panTo: function(e, t, i) {
                i || (e > K.min.x ? e = K.min.x : e < K.max.x && (e = K.max.x),
                t > K.min.y ? t = K.min.y : t < K.max.y && (t = K.max.y)),
            ...
            goTo: function(e, t, i) {
                ...
                if ("slide" === a)
                    ...
                    We(),
                    J = !1,
                    q.popup.image_anim && !q.popup.image_anim.paused && q.popup.image_anim.pause();
                    var s = !!q.popup.transitions.hasOwnProperty(a) && q.popup.transitions[a](t);
                    if (q.popup.caption_transition_delay = s && s.duration || 0,
                    n.updateCurrItem(),
                    !s)
                        return;
                    ...
                    q.popup.image_timer = setTimeout((function() {
            ...
            updateCurrZoomItem: function(e) {
                ...
                Q = t.length && t[0].classList.contains("pswp__zoom-wrap") ? t[0].style : null,
                K = n.currItem.bounds,
            ...
            updateSize: function(e) {
                if (re.x = q.popup.scrollwrap.clientWidth,
                re.y = q.popup.scrollwrap.clientHeight,
                Pe(),
                me.x = re.x + Math.round(re.x * o.spacing),
                me.y = re.y,
                Me(me.x * pe),
                be("beforeResize"),
                void 0 !== d) {
                    for (var t, i, a, l = 0; l < 3; l++)
                        ...
                        a = c + l - 1,
                        o.loop && Zt() > 2 && (a = _e(a)),
                        (i = Ot(a)) && (h || i.needsUpdate || !i.bounds) ? (n.cleanSlide(i),
                        n.setContent(t, a),
                        1 === l && (n.currItem = i,
                        n.updateCurrZoomItem(!0)),
                        i.needsUpdate = !1) : -1 === t.index && a >= 0 && n.setContent(t, a),
                        i && i.container && (qt(i, re),
                        Bt(i),
                        He(i));
                    h = !1
                }
                g = v = n.currItem.initialZoomLevel,
                (K = n.currItem.bounds) && (se.x = K.center.x,
                se.y = K.center.y,
                Ce(!0)),
                be("resize")
            },
        ...
        }, Ye = {}, Ge = {}, Ke = {}, Qe = {}, Je = {}, $e = [], et = {}, tt = [], it = {}, at = 0, nt = {
            x: 0,
            y: 0
        }, ot = 0, lt = {
            x: 0,
            ...
            ))) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (bt[0] = vt(e.touches[0], ht),
            e.touches.length > 1 && (bt[1] = vt(e.touches[1], xt))) : (ht.x = e.pageX,
            ht.y = e.pageY,
            ht.id = "",
            bt[0] = ht),
            bt
            ...
            if (i = r > K.min[e] || r < K.max[e] ? o.panEndFriction : 1,
            r = se[e] + t[e] * i,
            (o.allowPanToNext || v === n.currItem.initialZoomLevel) && (Q ? "h" !== $ || "x" !== e || F || (c ? (r > K.min[e] && (i = o.panEndFriction,
            K.min[e] - r,
            a = K.min[e] - le[e]),
            (a <= 0 || d < 0) && Zt() > 1 ? (s = p,
            d < 0 && p > et.x && (s = et.x)) : K.min.x !== K.max.x && (l = r)) : (r < K.max[e] && (i = o.panEndFriction,
            r - K.max[e],
            a = le[e] - K.max[e]),
            (a <= 0 || d > 0) && Zt() > 1 ? (s = p,
            d > 0 && p < et.x && (s = et.x)) : K.min.x !== K.max.x && (l = r))) : s = p,
            "x" === e))
                return void 0 !== s && (Me(s, !0),
                B = s !== et.x),
                K.min.x !== K.max.x && (void 0 !== l ? se.x = l : B || (se.x += t.x * i)),
                void 0 !== s;
                ...
                if (0 !== e)
                    ...
                    Y && e > 1) {
                        ...
                        if (!$)
                            return;
                        if (ee && (ee = !1,
                        Math.abs(Ke.x) >= 10 && (Ke.x -= X[0].x - Je.x),
                        Math.abs(Ke.y) >= 10 && (Ke.y -= X[0].y - Je.y)),
                        Qe.x = Ye.x,
                        Qe.y = Ye.y,
                        0 === Ke.x && 0 === Ke.y)
                            return;
            ...
            N || F || J || R)
                if (We(),
                O || (O = Mt()),
                O.calculateSwipeSpeed("x"),
                R) {
                    if (_t() < o.verticalDragRange)
                        n.close();
                    else {
                        var c = se.y
                          , p = ie;
            ...
            var e, t, i = {
                ...
                calculateSwipeSpeed: function(a) {
                    tt.length > 1 ? (e = ye() - S + 50,
                    t = tt[tt.length - 2][a]) : (e = ye() - T,
                    t = Je[a]),
                    i.lastFlickOffset[a] = Qe[a] - t,
                ...
                calculateOverBoundsAnimOffset: function(e, t) {
                    i.backAnimStarted[e] || (se[e] > K.min[e] ? i.backAnimDestination[e] = K.min[e] : se[e] < K.max[e] && (i.backAnimDestination[e] = K.max[e]),
                    void 0 !== i.backAnimDestination[e] && (i.slowDownRatio[e] = .7,
                    i.slowDownRatioReverse[e] = 1 - i.slowDownRatio[e],
                    i.speedDecelerationRatioAbs[e] < .05 && (i.lastFlickSpeed[e] = 0,
                    i.backAnimStarted[e] = !0,
                    Be("bounceZoomPan" + e, se[e], i.backAnimDestination[e], t || 300, ce.easing.sine.out, (function(t) {
                        se[e] = t,
                        Ce()
                    }
                    )))))
                ...
                panAnimLoop: function() {
                    if (Fe.zoomPan && (Fe.zoomPan.raf = M(i.panAnimLoop),
                    i.now = ye(),
            ...
            at === c && (a = !1),
            J = !0,
            a && q.popup.toggle_timer(!1),
            Be("mainScroll", lt.x, d, p, ce.easing.cubic.out, Me, (function() {
                We(),
                J = !1,
                at = -1,
            ...
            v < t ? e = t : v > i && (e = i);
            var a, o = ie;
            return te && !Z && !ae && v < t ? (n.close(),
            !0) : (te && (a = function(e) {
                we((1 - o) * e + o)
            }
            ),
            n.zoomTo(e, 0, 200, ce.easing.cubic.out, a),
            !0)
        };
        ge("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    H ? e("pointer", "down", "move", "up", "cancel") : E.touch ? (e("touch", "start", "move", "end", "cancel"),
        ...
        var Et, It, Tt, St, Ot, Zt, Rt = function(t, i, a, l) {
            ...
            var p = a ? o.hideAnimationDuration : o.showAnimationDuration
              , d = function() {
                ...
                q.popup.bg.style.removeProperty("opacity")) : (we(1),
            ...
            if (!p || !s || void 0 === s.x)
                ...
                a ? e.style.opacity = 0 : (v = t.initialZoomLevel,
            ...
            se.x = s.x,
            se.y = s.y - A,
            q.popup[u ? "pswp" : "bg"].style.opacity = .001,
            Ce()),
            Ue("initialZoom"),
            a && !m && e.classList.remove("pswp--animated-in"),
            u && (a ? ce.toggle_class(e, "pswp--animate_opacity", !m) : setTimeout((function() {
                ...
                a) {
                    var i = s.w / t.w
                      ...
                      , r = function(t) {
                        1 === t ? (v = i,
                        se.x = s.x,
                        se.y = s.y - j) : (v = (i - o) * t + o,
                        se.x = (s.x - n.x) * t + n.x,
                        se.y = (s.y - j - n.y) * t + n.y),
                        Ce(),
                        u ? e.style.opacity = 1 - t : we(l - t * l)
                    };
                    m ? Be("initialZoom", 0, 1, p, ce.easing.cubic.out, r, d) : (r(1),
            ...
            if (e.src && e.loadError && e.container)
                return t && ce.resetEl(e.container),
            ...
            if (Pt.length) {
                for (var e, t = 0; t < Pt.length; t++)
                    (e = Pt[t]).holder.index === e.index && Nt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                Pt = []
            }
        };
        ge("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = _e(e);
                    var t = Ot(e);
                    t && (!t.loaded && !t.loading || h) && (be("gettingData", e, t),
                    t.src && Ut(t))
                },
                initController: function() {
                    ...
                    xe("beforeChange", (function(e) {
                        var t, i = o.preload, a = null === e || e >= 0, l = Math.min(i[0], Zt()), s = Math.min(i[1], Zt());
                        for (t = 1; t <= (a ? s : l); t++)
                            n.lazyLoadItem(c + t);
                        for (t = 1; t <= (a ? l : s); t++)
                            n.lazyLoadItem(c - t)
                ...
                setContent: function(e, t) {
                    ...
                    if (s) {
                        ...
                        !s.src || s.loadError || s.loaded)
                            s.src && !s.loadError && ((a = ce.createEl("pswp__img", "img")).style.opacity = 1,
                            a.src = s.src,
                            Bt(s, a),
                            Nt(0, s, r, a));
                        else {
                            s.loadComplete = function(i) {
                                if (l) {
                                    if (e && e.index === t) {
                                        ...
                                        i.imageAppended ? !St && i.placeholder && (i.placeholder.style.display = "none",
                                        i.placeholder = null) : J || St ? Pt.push({
                                            item: i,
                                            baseDiv: r,
                                            img: i.img,
                                            index: t,
        ...
        var Yt, Gt, Kt = {}, Qt = function(e, t, i) {
            ...
            publicMethods: {
                ...
                setupDesktopZoom: function(t) {
                    ...
                    var a, o = function() {
                        ...
                        n.mouseZoomedIn = !1),
                        ce.toggle_class(e, "pswp--zoom-allowed", v < 1),
                        l()
                    }, l = function() {
                ...
                handleMouseWheel: function(e) {
                    if (v <= n.currItem.fitRatio)
                        return !o.closeOnScroll || qe || D ? e.preventDefault() : Math.abs(e.deltaY) > 2 && (r = !0,
                        n.close()),
                        !0;
                    if (e.stopPropagation(),
                    Gt.x = 0,
                    "deltaX"in e)
                        1 === e.deltaMode ? (Gt.x = 18 * e.deltaX,
                        Gt.y = 18 * e.deltaY) : (Gt.x = e.deltaX,
                        Gt.y = e.deltaY);
                    else if ("wheelDelta"in e)
                        e.wheelDeltaX && (Gt.x = -.16 * e.wheelDeltaX),
                        e.wheelDeltaY ? Gt.y = -.16 * e.wheelDeltaY : Gt.y = -.16 * e.wheelDelta;
                    else {
                        if (!("detail"in e))
                            return;
                        Gt.y = e.detail
                ...
                toggleDesktopZoom: function(t) {
                    ...
                    ce.toggle_class(e, "pswp--zoomed-in", !a)
                }
            }
        });
    ...
    !function() {
        if (_c.menu_enabled) {
            N.sidebar = _id("sidebar"),
            N.sidebar_inner = _id("sidebar-inner"),
            N.sidebar_menu = _id("sidebar-menu"),
            N.sidebar_toggle = _id("sidebar-toggle"),
            N.sidebar_modal = _id("sidebar-bg"),
            N.sidebar_topbar = _id("sidebar-topbar");
            var e, a, n, o, s, r = !1, c = !1, p = {}, d = !1, m = E.get_json("files:interface:menu-expanded:" + _c.location_hash), u = _c.menu_show && matchMedia("(min-width: 992px)").matches;
            u || document.documentElement.classList.add("sidebar-closed"),
            P.menu_loading = function(e, t) {
                e || (e = c),
            ...
            P.set_menu_active = function(e) {
                ...
                (c = !!i && i.firstChild) != t && (t && P.menu_loading(t, !1),
                g(t, !1),
                g(c, !0))
            }
            ,
            N.sidebar_toggle.innerHTML = P.get_svg_icon_multi("menu", "menu_back"),
            y(N.sidebar_toggle, L, "click"),
            y(N.sidebar_modal, L, "click"),
            P.create_menu = A;
            ...
            !(!f || v && !function() {
                for (var e = f.length, t = 0; t < e; t++)
                    if (f[t].path.includes("/"))
                        return !1;
                return !0
            }()) ? A(f, "menu from localstorage [" + (_c.menu_cache_validate ? "shallow menu" : "menu cache validation disabled") + "]") : (N.sidebar_menu.classList.add("sidebar-spinner"),
            N.sidebar_menu.dataset.title = X.get("loading"),
            I({
                params: !_c.menu_cache_file && "action=dirs" + (_c.cache ? "&menu_cache_hash=" + _c.menu_cache_hash : "") + (f ? "&localstorage=1" : ""),
                url: _c.menu_cache_file,
                json_response: !0,
                complete: function(e, t, i) {
                    if (N.sidebar_menu.classList.remove("sidebar-spinner"),
                    delete N.sidebar_menu.dataset.title,
                    !i || !e || e.error || !Object.keys(e).length)
                        return K(),
                        void z("Error or no dirs!");
                    e.localstorage ? A(f, "menu from localstorage") : (A(e, "menu from " + (_c.menu_cache_file ? "JSON cache: " + _c.menu_cache_file : "xmlhttp")),
                    U.local_storage && setTimeout((function() {
                        P.clean_localstorage(),
        ...
        function g(e, t) {
            if (e && e.isConnected) {
                ...
                for (var i = e.parentElement.parentElement.parentElement; "LI" === i.nodeName; )
        ...
        function _(t, i) {
            ...
            var o = Object.keys(p).length
              , l = o === n.length;
            d !== l && (d = l,
            U.is_pointer && (e.title = X.get(d ? "collapse menu" : "expand menu")),
            e.classList.toggle("is-expanded", d)),
            U.local_storage && (r && clearTimeout(r),
        ...
        function h(e, t, i) {
            ...
            var n = {
                ...
                duration: 250,
                complete: function() {
                    a.style.cssText = "--depth:" + (e.dataset.level || 0),
                    i && i()
                }
            };
            anime(n),
            e.classList.toggle("menu-li-open", t)
        }
        function L(e) {
            P.set_config("menu_show", !_c.menu_show),
        ...
        function V(e, a) {
            ...
            return a ? (n += " has-ul",
            m && m[e.path] && (n += " menu-li-open",
            p[e.path] = !0)) : e.is_readable || (o += " menu-a-forbidden"),
            '<li data-level="' + s + '" data-path="' + t(e.path) + '" class="' + n + '"><a href="' + l(e) + '" class="' + o + '">' + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-toggle", "plus", "minus") : "") + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-folder menu-icon-folder-toggle", r, "folder_plus", "folder_minus") : P.get_svg_icon_class(r, "menu-icon menu-icon-folder")) + i(e.basename) + "</a>"
        }
        function A(t, i) {
            var l, r, m, f, v, g;
            if (K(),
            ...
            k(_c.dir_paths, (function(e, t) {
                if (e) {
                    ...
                    m += a,
                    f && (l += V(f, a > 0)),
                    l += a > 0 ? '<ul style="--depth:' + (m - 1) + '" class="menu-' + (f ? "ul" : "root") + '">' : "</li>" + M("</ul></li>", -a),
                    f = _c.dirs[e]
                }
            }
            )),
            l += V(f, !1) + M("</li></ul>", m),
            N.sidebar_menu.innerHTML = l,
            a = N.sidebar_menu.firstChild,
            n = _class("has-ul", a),
            o = n.length ? H(Array.from(a.children), "has-ul", !0) : [],
            v = o,
            ...
            P.set_menu_active(_c.current_path || _c.init_path),
            U.local_storage && (N.sidebar_menu.scrollTop = E.get("files:interface:menu_scroll:" + _c.location_hash) || 0,
            y(N.sidebar_menu, w((function() {
                E.set("files:interface:menu_scroll:" + _c.location_hash, N.sidebar_menu.scrollTop, !0)
            }
            ), 1e3), "scroll")),
            n.length && (g = !1,
            d = Object.keys(p).length === n.length,
            N.sidebar_topbar.innerHTML = '<button id="menu-toggle" type="button" class="btn-icon' + (d ? " is-expanded" : "") + '">' + P.get_svg_icon_multi("plus", "minus") + "</button>",
            y(e = N.sidebar_topbar.lastElementChild, (function(e) {
                if (d) {
                    var t = []
                      , i = []
                      , a = !1
                    ...
                    k(o, (function(e) {
                        if (e.classList.contains("menu-li-open"))
                            if (a)
                                ...
                                n.top > l || n.bottom - n.top > 2 * l ? (t.push(e),
                                a = !0) : i.push(e)
                            }
                    }
                    )),
                    ...
                    n.length > 100 ? C(n, "menu-li-open", !0) : (t = [],
                    i = [],
                    a = !1,
                    l = window.innerHeight,
                    k(n, (function(e) {
                        e.classList.contains("menu-li-open") || (a || !e.offsetParent ? t.push(e) : e.getBoundingClientRect().top > l || e.lastChild.childNodes.length > 50 ? (a = !0,
                        t.push(e)) : i.push(e))
                    }
                    )),
                    t.length && k(t, (function(e) {
            ...
            _c.transitions && u) {
                ...
                A.delay = anime.stagger(O(20, 50, Math.round(200 / A.targets.length))),
                anime(A)
            }
            y(a, (function(e) {
                if (q.contextmenu.is_open)
                ...
                if (e.target !== a) {
                    ...
                    if (!b(e, n))
                        if (t && n !== c)
                            P.get_files(i.dataset.path, "push"),
                            matchMedia("(min-width: 992px)").matches ? _c.menu_show || x(N.sidebar, "sidebar-clicked", null, 1e3) : L();
    ...
    function me() {
        ...
        !_c.prevent_right_click && _c.context_menu && (N.files && N.files.addEventListener("contextmenu", (function(e) {
    ...
    !function() {
        ...
        q.sort.keys.includes(t[0]) || (t[0] = "name"),
        t[1] && ["asc", "desc"].includes(t[1]) || (t[1] = q.sort.sorting[t[0]].order),
        ...
        function r(e, t, i) {
            var a = i ? "add" : "remove";
            e && (o[q.sort.index].classList[a]("active"),
            c[q.sort.index].classList[a]("sortbar-active")),
            (e || t) && (o[q.sort.index].classList[a]("sort-" + q.sort.order),
            c[q.sort.index].classList[a]("sort-" + q.sort.order))
        }
        P.set_sort = function(t) {
            if (t) {
                ...
                r(i, o, !1),
                e(t, n),
                a.innerHTML = P.get_svg_icon("sort_" + t + "_" + n),
                r(i, o, !0),
                P.set_config("sort", q.sort.sort + "_" + q.sort.order)
            }
            _c.debug && console.time("sort"),
            q.list.sort(q.sort.prop, {
                order: q.sort.order,
        ...
        p(n, P.set_sort),
        N.sortbar = _id("files-sortbar"),
        N.sortbar.className = "sortbar-" + _c.layout,
        N.sortbar.innerHTML = '<div class="sortbar-inner">' + M(q.sort.keys, (function(e) {
    ...
    function() {
        if (N.topbar_top = _id("topbar-top"),
        q.topbar = {
            info: {}
        },
        N.filter.placeholder = X.get("filter"),
        N.filter.title = U.c_key + "F",
        oe.hash(),
        N.filter.parentElement.insertAdjacentHTML("beforeend", P.get_svg_icon("search")),
        X.dropdown(),
        _c.has_login) {
        ...
        screenfull.isEnabled && (N.topbar_top.insertAdjacentHTML("beforeend", '<button class="btn-icon btn-topbar" id="topbar-fullscreen">' + P.get_svg_icon_multi("expand", "collapse") + "</button>"),
        y(N.topbar_top.lastElementChild, (function() {
            screenfull.toggle()
        }
        )),
        ...
        P.topbar_info = function(e, t) {
            N.topbar_info.className = "info-" + t,
            N.topbar_info.innerHTML = e
        }
        ,
        P.topbar_info_search = function(e, t) {
            if (A(N.sortbar, !t),
            !e)
                return N.topbar_info.className = "info-hidden";
            N.topbar_info.classList.contains("info-search") ? (N.topbar_info.classList.toggle("info-nomatch", !t),
            N.topbar_info.children[0].textContent = t,
            N.topbar_info.children[2].textContent = e) : P.topbar_info('<span class="info-search-count">' + t + '</span><span class="info-search-lang"><span data-lang="matches found for">' + X.get("matches found for") + '</span></span><span class="info-search-phrase">' + e + '</span><button class="info-search-reset" data-action="reset">' + P.get_svg_icon("close") + "</button>", "search" + (t ? "" : " info-nomatch"))
        }
    }(),
